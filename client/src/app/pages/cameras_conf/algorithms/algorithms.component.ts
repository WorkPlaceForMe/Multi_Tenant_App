          ...
          for (let i = 0; i < this.algos.length; i++) {
            for (let t = 0; t < res['data'].length; t++) {
              ...
              if (this.algos[i]['available'] === 1) {
                ...
                } else if (this.algos[i]['id'] > 3 && this.algos[i]['id'] <= 8 || this.algos[i]['id'] === 5 || this.algos[i]['id'] === 13 || this.algos[i]['id'] === 25 || this.algos[i]['id'] === 26 || this.algos[i]['id'] === 28 || this.algos[i]['id'] === 29 || this.algos[i]['id'] === 30 || this.algos[i]['id'] === 31 || this.algos[i]['id'] === 33 || this.algos[i]['id'] === 58) {
