...
export class AlgorithmsComponent implements OnInit {
      ...
      .subscribe(
        res => {
          for (let i = 0; i < this.algos.length; i++){
            ...
            }else if (this.algos[i]['id'] > 3 && this.algos[i]['id'] <= 8 || this.algos[i]['id'] === 13 || (this.algos[i]['id'] >= 25 || this.algos[i]['id'] <= 34)){
  ...
  camera: Camera = {
    ...
    relations: any = [];
    algos: any = [
      {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false}, {activated: false},
    ];
    Aalgos: any = [];
    Balgos: any = [];
    Calgos: any = [];
...
saave(){
  ...
  data.push(this.algos, this.climb, this.loiteringTime, this.aod, this.speed, this.unwanted, this.dac, this.quantity);
