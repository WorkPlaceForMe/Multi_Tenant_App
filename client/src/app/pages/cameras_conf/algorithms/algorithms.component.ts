          ...
          for (let i = 0; i < this.algos.length; i++) {
            for (let t = 0; t < res['data'].length; t++) {
              ...
              if (this.algos[i]['available'] === 1) {
                if (this.algos[i]['id'] <= 3 || this.algos[i]['id'] === 12 || this.algos[i]['id'] === 14 || this.algos[i]['id'] === 15 || this.algos[i]['id'] === 16 || this.algos[i]['id'] === 17 || this.algos[i]['id'] === 18 || this.algos[i]['id'] === 19 || this.algos[i]['id'] === 20 || this.algos[i]['id'] === 21 || this.algos[i]['id'] === 22 || this.algos[i]['id'] === 23 || this.algos[i]['id'] === 24 || this.algos[i]['id'] === 32 || this.algos[i]['id'] === 35 || this.algos[i]['id'] === 38 || this.algos[i]['id'] === 36 || this.algos[i]['id'] === 37 || this.algos[i]['id'] === 40 || this.algos[i]['id'] === 41 || this.algos[i]['id'] === 42 || this.algos[i]['id'] === 43 || this.algos[i]['id'] === 44 || this.algos[i]['id'] === 45 || this.algos[i]['id'] === 46 || this.algos[i]['id'] === 47 || this.algos[i]['id'] === 48 || this.algos[i]['id'] === 49 || this.algos[i]['id'] === 50) {
