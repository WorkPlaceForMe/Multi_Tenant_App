          ...
          for (let i = 0; i < this.algos.length; i++) {
            for (let t = 0; t < res['data'].length; t++) {
              ...
              if (this.algos[i]['available'] === 1) {
                ...
                } else if (this.algos[i]['id'] > 8 && this.algos[i]['id'] <= 11 || this.algos[i]['id'] === 27 || this.algos[i]['id'] === 39 || this.algos[i]['id'] === 53 || this.algos[i]['id'] === 54 || this.algos[i]['id'] === 55 || this.algos[i]['id'] === 56 || this.algos[i]['id'] === 66 || this.algos[i]['id'] === 64|| this.algos[i]['id'] === 69|| this.algos[i]['id'] === 73) {
