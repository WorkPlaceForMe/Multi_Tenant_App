...
@Component({
  selector: 'ngx-conteo-de-personal',
  templateUrl: './conteo-de-personal.component.html',
  styleUrls: ['./conteo-de-personal.component.scss']
})
export class ConteoDePersonalComponent implements OnInit , OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.conteo(this.camera, l).subscribe(
      (res) => {
        this.conteo = res["data"];
        for (var m of this.conteo.raw) {
          m['videoClip']  = this.sanitizer.bypassSecurityTrustUrl(api + '/pictures/' + this.now_user['id_account'] + '/' + m['id_branch'] + '/conteo/' + m['cam_id'] + '/' + m['movie']);
        ...
        this.source = this.conteo.raw.slice().sort((a, b) => +new Date(b.time) - +new Date(a.time));
        let labels = [];
        for (var o of Object.keys(this.conteo.over)) {
          o = o + ":00:00";
            ...
            datasets: [
              {
                ...
                data: Object.values(this.conteo.over),
