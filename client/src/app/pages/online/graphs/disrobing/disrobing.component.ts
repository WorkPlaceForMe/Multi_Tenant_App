    ...
    let l = {
      ...
      this.serv.disrobing(this.camera,l).subscribe(
        res=>{
          ...
          this.source = this.disrobing.raw.slice().sort((a, b) => +new Date(b.time) - +new Date(a.time))

          let labels = []
          for(var o of Object.keys(this.disrobing.over)){
            o = o + ':00:00'
          ...
          this.themeSubscription = this.theme.getJsTheme().subscribe(config => {
            ...
            this.dataL = {
              labels: labels,
              datasets: [{
                label: 'Disrobs over time',
                backgroundColor: NbColorHelper.hexToRgbA(colors.primary, 0.3),
                data: Object.values(this.disrobing.over),
