...
export class PurseSnatchingComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.serv.purse(this.camera, l).subscribe(
      (res) => {
        this.purse = res["data"];
        for (var m of this.purse.raw) {
          ...
          m["clip_path"] =
            ...
            "/" +
            m["clip_path"];
            m['videoClip']  = this.sanitizer.bypassSecurityTrustUrl(api + '/pictures/' + this.now_user['id_account'] + '/' + m['id_branch'] + '/purse_snatching/' + m['cam_id'] + '/' + m['movie']);
            ...
            datasets: [
              {
                ...
                data: Object.values(this.purse.over),
