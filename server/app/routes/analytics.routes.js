...
module.exports = function (app) {
  ...
  app.post('/api/analytics/69/:id', [authJwt.isAvailable, authJwt.verifyToken], controller.blackWhite)

  app.post('/api/analytics/15/:id', [authJwt.isAvailable, authJwt.verifyToken], controller.demographics)
}
