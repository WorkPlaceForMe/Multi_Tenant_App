...
module.exports = function (app) {
   ...
   */
  app.post('/api/analytics/2/:id', [authJwt.verifyToken], controller.loitering)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/17/:id', [authJwt.verifyToken], controller.intrude)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/19/:id', [authJwt.verifyToken], controller.violence)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/16/:id', [authJwt.verifyToken], controller.aod)
  /**
   * @swagger
   * /api/analytics/20/{id}:
   *   post:
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/20/:id', [authJwt.verifyToken], controller.covered)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/21/:id', [authJwt.verifyToken], controller.social)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/12/:id', [authJwt.verifyToken], controller.pc)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/6/:id', [authJwt.verifyToken], controller.helm)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/22/:id', [authJwt.verifyToken], controller.queue)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/24/:id', [authJwt.verifyToken], controller.vault)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/4/:id', [authJwt.verifyToken], controller.parking)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/13/:id', [authJwt.verifyToken], controller.anpr)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/25/:id', [authJwt.verifyToken], controller.barrier)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/26/:id', [authJwt.verifyToken], controller.vc)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/27/:id', [authJwt.verifyToken], controller.tamper)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/29/:id', [authJwt.verifyToken], controller.accident)
  /**
   * @swagger
   * /api/analytics/28/{id}:
   *   post:
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/28/:id', [authJwt.verifyToken], controller.animal)
  /**
   * @swagger
   * /api/analytics/30/{id}:
   *   post:
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/30/:id', [authJwt.verifyToken], controller.axle)
  /**
   * @swagger
   * /api/analytics/31/{id}:
   *   post:
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/31/:id', [authJwt.verifyToken], controller.carmake)
  /**
   * @swagger
   * /api/analytics/33/{id}:
   *   post:
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/33/:id', [authJwt.verifyToken], controller.vcount)
  /**
   * @swagger
   * /api/analytics/8/{id}:
   *   post:
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/8/:id', [authJwt.verifyToken], controller.direction)
  /**
   * @swagger
   * /api/analytics/5/{id}:
   *   post:
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/5/:id', [authJwt.verifyToken], controller.speeding)
  /**
   * @swagger
   * /api/analytics/0/{id}:
   *   post:
  ...
  app.post('/api/analytics/0/:id', [authJwt.verifyToken], controller.fr)
  ...
  app.post('/api/analytics/32/:id', [authJwt.verifyToken], controller.cloth)
  /**
   * @swagger
   * /api/analytics/34/{id}:
   *   post:
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/34/:id', [authJwt.verifyToken], controller.brand)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/39/:id', [authJwt.verifyToken], controller.fire)
   ...
   *                 example: Error message generated by the server
   */
  app.post('/api/analytics/38/:id', [authJwt.verifyToken], controller.collapse)

  app.post('/api/analytics/35/:id', [authJwt.verifyToken], controller.weapon)

  app.post('/api/analytics/36/:id', [authJwt.verifyToken], controller.bottle)

  app.post('/api/analytics/41/:id', [authJwt.verifyToken], controller.waving)

  app.post('/api/analytics/42/:id', [authJwt.verifyToken], controller.smoking)

  app.post('/api/analytics/44/:id', [authJwt.verifyToken], controller.slapping)

  app.post('/api/analytics/46/:id', [authJwt.verifyToken], controller.running)

  app.post('/api/analytics/50/:id', [authJwt.verifyToken], controller.pushing)

  app.post('/api/analytics/48/:id', [authJwt.verifyToken], controller.purse)

  app.post('/api/analytics/40/:id', [authJwt.verifyToken], controller.hair)

  app.post('/api/analytics/49/:id', [authJwt.verifyToken], controller.following)

  app.post('/api/analytics/47/:id', [authJwt.verifyToken], controller.disrobing)

  app.post('/api/analytics/43/:id', [authJwt.verifyToken], controller.crowd)

  app.post('/api/analytics/45/:id', [authJwt.verifyToken], controller.blocking)

  app.post('/api/analytics/52/:id', [authJwt.verifyToken], controller.transpassing)

  app.post('/api/analytics/53/:id', [authJwt.verifyToken], controller.cameraDefocused)

  app.post('/api/analytics/55/:id', [authJwt.verifyToken], controller.sceneChange)

  app.post('/api/analytics/54/:id', [authJwt.verifyToken], controller.cameraBlinded)

  app.post('/api/analytics/56/:id', [authJwt.verifyToken], controller.objectRemoval)

  app.post('/api/analytics/57/:id', [authJwt.verifyToken], controller.smokeDetection)

  app.post('/api/analytics/58/:id', [authJwt.verifyToken], controller.velocity)

  app.post('/api/analytics/60/:id', [authJwt.verifyToken], controller.exit)

  app.post('/api/analytics/59/:id', [authJwt.verifyToken], controller.enterExit)

  app.post('/api/analytics/61/:id', [authJwt.verifyToken], controller.harrasment)

  app.post('/api/analytics/62/:id', [authJwt.verifyToken], controller.abduction)

  app.post('/api/analytics/63/:id', [authJwt.verifyToken], controller.direction)
}
